...
public:
  ...
  //Array seems to hard to implement for lineSplit cause we do not know the initial size, and recreating array everytime and
  //copying the elements to new array is probably bad, so linked list might be best
